...
if(wgCanonicalSpecialPageName == 'Chat') {
  (function(){
    ...
    if (!$("#chat-options-button").length) {
      ...
      $('.Rail').prepend('<div id="chat-options-button"><img height="16" width="16" class="sprite gear" src="data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D" /><div class="chat-options">Options</div></div>');
